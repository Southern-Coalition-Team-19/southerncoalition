...
/**	
 * <br><a href="http://localhost:8983/solr/computate/select?q=*:*&fq=partEstClasse_indexed_boolean:true&fq=classeNomCanonique_enUS_indexed_string:org.southerncoalition.enus.vertx.WorkerVerticle&fq=classeEtendGen_indexed_boolean:true">Find the class  in Solr. </a>
 * <br>
 **/
public abstract class WorkerVerticleGen<DEV> extends AbstractVerticle {
	...
	public static final String migrateAllDataComplete1 = "Refresh all data completed. ";
	public static final String migrateAllDataComplete = migrateAllDataComplete1;
	public static final String migrateAllDataStarted1 = "Refresh all data started. ";
	public static final String migrateAllDataStarted = migrateAllDataStarted1;
	public static final String migrateAllDataFail1 = "Refresh all data failed. ";
	public static final String migrateAllDataFail = migrateAllDataFail1;
	public static final String migrateAllDataSkip1 = "Refresh all data skipped. ";
	public static final String migrateAllDataSkip = migrateAllDataSkip1;

	public static final String migrateDataComplete1 = "%s migrate completed. ";
	public static final String migrateDataComplete = migrateDataComplete1;
	public static final String migrateDataStarted1 = "%s data sync started. ";
	public static final String migrateDataStarted = migrateDataStarted1;
	public static final String migrateDataSkip1 = "%s migrate skipped. ";
	public static final String migrateDataSkip = migrateDataSkip1;
	public static final String migrateDataFail1 = "%s migrate failed. ";
	public static final String migrateDataFail = migrateDataFail1;
	public static final String migrateDataCounterResetFail1 = "%s data sync failed to reset counter. ";
	public static final String migrateDataCounterResetFail = migrateDataCounterResetFail1;

	public static final String migrateDataTableFail1 = "Migrating %s row failed. ";
	public static final String migrateDataTableFail = migrateDataTableFail1;

	public static final String migrateDataRowComplete1 = "Importing %s row completed. ";
	public static final String migrateDataRowComplete = migrateDataRowComplete1;
	public static final String migrateDataRowFail1 = "Importing %s row failed. ";
	public static final String migrateDataRowFail = migrateDataRowFail1;
